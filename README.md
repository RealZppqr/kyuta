...
git clone https://github.com/RealZppqr/kyuta.git
cd kyuta
...
git clone -b develop https://github.com/RealZppqr/kyuta.git
cd kyuta
...
1. **Fork the repository**
   ...
   git clone https://github.com/RealZppqr/kyuta.git
   cd kyuta
   git remote add upstream https://github.com/RealZppqr/kyuta.git
   ```
...
**Built with ❤️ by [Zppqr](https://github.com/RealZppqr)**
